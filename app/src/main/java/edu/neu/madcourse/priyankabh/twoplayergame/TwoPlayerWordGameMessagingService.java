...
public class TwoPlayerWordGameMessagingService extends FirebaseMessagingService {
    private static final String TAG = TwoPlayerWordGameMessagingService.class.getSimpleName();
