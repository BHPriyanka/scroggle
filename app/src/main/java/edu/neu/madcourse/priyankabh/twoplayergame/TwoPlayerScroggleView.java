...
public class TwoPlayerScroggleView extends View {
    private Drawable mBackground;
    private int mScrollPos;

    public TwoPlayerScroggleView(Context context) {
        super(context);
        init(null, 0);
    }

    public TwoPlayerScroggleView(Context context, AttributeSet attrs) {
        super(context, attrs);
        init(attrs, 0);
    }

    public TwoPlayerScroggleView(Context context, AttributeSet attrs, int defStyle) {
